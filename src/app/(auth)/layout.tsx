  ...
  return (
    <div className="min-h-[100dvh] flex bg-[var(--color-surface)]">
      ...
      <div className="hidden lg:flex w-[45%] bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-rosa)] relative overflow-hidden items-end p-12">
        {/* Estampa de fundo */}
        <div className="absolute inset-0 opacity-[0.08] pointer-events-none" style={{ backgroundImage: 'url(/Estampa-Logo.png)', backgroundSize: '500px', backgroundRepeat: 'repeat' }} />
        {/* Ambient shapes */}
