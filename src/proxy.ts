...
const publicRoutes = ['/checkout', '/login', '/forgot-password', '/termos', '/privacidade', '/resumos-verbais', '/produto']
const apiPublicRoutes = ['/api/auth', '/api/webhooks', '/api/coupons/validate', '/api/checkout', '/api/products']
